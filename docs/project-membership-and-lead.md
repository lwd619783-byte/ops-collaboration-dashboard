...
本任务不实现项目邀请/审批、任务、进展、验收、提醒、评论、附件、审计日志、归档恢复、项目或用户物理删除、批量成员操作、公开分享、远端 Supabase migration 或生产部署。项目模块由后续 [项目工作模块 V1](project-modules.md) 独立实现；阶段 3 能力仍必须由后续独立任务授权。
